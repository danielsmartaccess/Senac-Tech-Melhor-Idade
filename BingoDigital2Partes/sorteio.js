...
function sortearDescricao() {
    ...
    // Adiciona o termo sorteado à lista de termos sorteados na tela
    adicionarTermoSorteadoNaLista(termos[indice].termo);
}

// Função para adicionar o termo sorteado à lista na tela
function adicionarTermoSorteadoNaLista(termo) {
    const lista = document.getElementById('termosSorteados');
